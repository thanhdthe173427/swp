...
public class BatchDAO {
    ...
    public List<Batch> getAll() {
        ...
        try (
            ...
            while (rs.next()) {
                ...
                int soldQty = oid.getSoldQuantityByBatchId(b.getId());
    ...
    public void add(Batch b) {
        conn = new DBContext().getConnection();
        String sql = "INSERT INTO batches(material_id, warehouse_id, supplier_id, batch_code, mfg_date, qty_on_hand, qty_reserved) VALUES (?,?,?,?,?,?,?)";
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
    ...
    public void update(Batch b) {
        conn = new DBContext().getConnection();
        String sql = "UPDATE batches             SET material_id=?, warehouse_id=?, supplier_id=?, batch_code=?, mfg_date=?, qty_on_hand=?, qty_reserved=?            WHERE id=?";
        try (PreparedStatement ps = conn.prepareStatement(sql)) {
