...
public class PaymentController extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        order.setStatus("Pending"); // ⬅️ LUÔN LUÔN là "Pending" khi mới tạo
        order.setPaymentStatus("Unpaid"); // ⬅️ LUÔN LUÔN là "Unpaid" khi mới tạo (kể cả COD)
        ...
        if (method.equalsIgnoreCase("vnpay")) {
            ...
            vnp_Params.put("vnp_OrderInfo", "Thanhtoandonhang#" + order.getOrderCode());
            ...
            for (Iterator<String> itr = fieldNames.iterator(); itr.hasNext();) {
                ...
                if (fieldValue != null && !fieldValue.isEmpty()) {
                    ...
                    // 1. Build hashData (luôn là dữ liệu thô, không encode)
                    hashData.append(fieldName).append('=').append(fieldValue);

                    // 2. Build query (mã hóa bằng UTF-8)
