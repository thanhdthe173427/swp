...
public class FormulaDAO {
    ...
    public List<Formula> getFormulaForProduct(Connection conn, long productId) throws SQLException {
        List<Formula> formulaItems = new ArrayList<>();
        // Bảng 'formulas' trong DB của bạn
        String sql = "SELECT material_id, quantity FROM formulas WHERE product_id = ?"; 
        ...
        // Không có try-catch-finally để đóng conn ở đây
        return formulaItems;
    }
