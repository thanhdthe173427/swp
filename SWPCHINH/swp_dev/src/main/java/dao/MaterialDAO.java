...
public class MaterialDAO {
    ...
    public List<Material> getAll() {
        ...
        try (Connection conn = new DBContext().getConnection();
            ...
            while (rs.next()) {
                ...
                int totalQty = inventoryDAO.getTotalQuantityByMaterialId(m.getId());
                m.setQuantity(totalQty);
                list.add(m);
            }
        } catch (SQLException e) {
    ...
    // trong MaterialDAO.java
    public BigDecimal getCostPrice(long materialId) {
        String sql = "SELECT cost_price FROM materials WHERE id = ?";
        try (Connection conn = new DBContext().getConnection();
             PreparedStatement ps = conn.prepareStatement(sql)) {
