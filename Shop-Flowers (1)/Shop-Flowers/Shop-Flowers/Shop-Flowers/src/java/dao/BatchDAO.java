...
public class BatchDAO {
    ...
    public void add(Batch b) {
        ...
        try {
            ...
            if (b.getWarehouseId() != null) ps.setLong(2, b.getWarehouseId()); else ps.setNull(2, Types.BIGINT);
            if (b.getSupplierInvoiceId() != null) ps.setLong(3, b.getSupplierInvoiceId()); else ps.setNull(3, Types.BIGINT);
