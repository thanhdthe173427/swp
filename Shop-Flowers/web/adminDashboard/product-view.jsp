    ...
    <body class="bg-gray-50">
        <div class="flex min-h-screen">
            <aside class="w-64 sidebar-gradient text-white flex-shrink-0">
                ...
                <nav class="mt-6">
                    <a href="admin-product" class="flex items-center gap-3 px-6 py-3 bg-white bg-opacity-20 border-l-4 border-white">
                        <i class="fas fa-box"></i>
                        <span>Quản Lý Hàng Hóa</span>
                    </a>
                    <a href="admin-categories" class="flex items-center gap-3 px-6 py-3 hover:bg-white hover:bg-opacity-10 transition">
