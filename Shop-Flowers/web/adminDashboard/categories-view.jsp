    ...
    <body class="bg-gray-50">
        <div class="flex min-h-screen">
            <aside class="w-64 sidebar-gradient text-white flex-shrink-0">
                ...
                <nav class="mt-6">
                    <a href="admin-product" class="flex items-center gap-3 px-6 py-3 hover:bg-white hover:bg-opacity-10 transition">
                        <i class="fas fa-box"></i>
                        <span>Quản Lý Hàng Hóa</span>
                    </a>
                    <a href="admin-categories" class="flex items-center gap-3 px-6 py-3 bg-white bg-opacity-20 border-l-4 border-white">
                        <i class="fas fa-chart-line"></i>
                        <span>Quản lý Danh Mục</span>
                    </a>
                    <a href="#" class="flex items-center gap-3 px-6 py-3 hover:bg-white hover:bg-opacity-10 transition">
            ...
            <main class="flex-1 overflow-auto">
                ...
                <div class="p-8">
                    ...
                    <button onclick="openModal()" 
                            class="bg-gradient-to-r from-purple-600 to-indigo-600 text-white px-6 py-2 rounded-lg hover:from-purple-700 hover:to-indigo-700 transition font-medium flex items-center gap-2">
    ...
    <div class="bg-white rounded-xl shadow-lg w-full max-w-lg p-6 relative">
        ...
        <form action="admin-categories" method="post" class="grid grid-cols-1 gap-4">
            ...
            <div class="flex justify-end gap-2 mt-4">
                ...
                <button type="submit" 
                        class="px-6 py-2 rounded-lg bg-gradient-to-r from-purple-600 to-indigo-600 text-white hover:from-purple-700 hover:to-indigo-700">Thêm</button>
            </div>
        </form>
    </div>
</div>
        ...
        <form id="updateProductForm" action="admin-categories" method="post" class="grid grid-cols-1 gap-4">
            ...
            <div class="flex justify-end gap-2 mt-4">
                ...
                <button type="submit" onclick="closeUpdateModal()"
                        class="px-4 py-2 rounded-lg border border-gray-300 hover:bg-gray-100">Cập nhật</button>
            </div>
        </form>
    </div>
</div>
