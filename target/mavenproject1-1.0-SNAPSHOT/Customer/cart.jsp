...
<body>
    <div class="cart-container">
        ...
        <!-- Form riêng cho nút thanh toán -->
        <form id="checkoutForm" action="<%= request.getContextPath()%>/Checkout" method="get" style="margin-top:20px;">
            ...
            <div class="cart-summary">
                ...
                <button type="submit" class="btn-checkout">💳 Thanh toán sản phẩm đã chọn</button>
            </div>
        </form>
    ...
    <script>
        ...
        // Khi bấm thanh toán → gửi danh sách ID sản phẩm đã chọn
