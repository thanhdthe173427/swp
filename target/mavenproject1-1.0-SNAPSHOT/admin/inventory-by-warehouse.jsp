    ...
    <main class="flex-1 overflow-auto">
        <header class="bg-white shadow-sm border-b border-gray-200">
            <div class="px-8 py-4 flex items-center justify-between">
                <div>
                    <h2 class="text-2xl font-bold text-gray-800">Danh sách nguyên liệu tồn kho</h2>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-sm font-semibold">Tên nguyên liệu</th>
                        ...
                        <c:forEach var="i" items="${inventoryList}">
                            <tr class="table-row border-b border-gray-200">
                                ...
                                <td class="px-6 py-4 text-sm text-gray-700">${i.materialName}</td>
    ...
    <div class="fixed inset-0 bg-black bg-opacity-40 flex items-center justify-center z-50">
        <div class="bg-white rounded-xl shadow-xl w-[700px] p-6">
            <div class="flex justify-between items-center border-b pb-3 mb-4">
                <h2 class="text-xl font-bold text-gray-800">📉 Những nguyên liệu sắp hết - Xem xét nhập thêm</h2>
            ...
            <div class="overflow-x-auto max-h-[400px] overflow-y-auto">
                <table class="w-full border border-gray-200">
                    ...
                    <tr>
                        ...
                        <th class="px-4 py-2 text-left text-sm font-semibold">Tên vật liệu</th>
                    ...
                    <c:forEach var="item" items="${lowStockList}">
                        <tr class="border-b hover:bg-gray-50">
                            ...
                            <td class="px-4 py-2 text-sm text-gray-700">${item.getMaterialName()}</td>
